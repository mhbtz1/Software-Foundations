...
Definition ltb (n m : nat) : bool
  := match (leb n m) with
     | true => (match (eqb n m) with | true => false
                                | false => true
                                end)
     | false => false
     end.
...
Definition grade_comparison (g1 g2 : grade) : comparison :=
  match g1, g2  with
  | (Grade l0 s0), (Grade l1 s1) => (match letter_comparison l0 l1 with
                                     | Eq => modifier_comparison s0 s1
                                     | _ => letter_comparison l0 l1
                                     end)
                                                                                                        end.
